...
import { LogoIcon, ChevronDownIcon, BellIcon, QuestionMarkCircleIcon, CogIcon } from './icons';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center group">
              ...
              <span className="ml-3 font-bold text-lg text-slate-800 tracking-tight group-hover:text-indigo-600 transition-colors whitespace-nowrap">
                {APP_TITLE}
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 border-r border-slate-200 pr-4">
              ...
              <Link to="/laboratories" className="p-2 rounded-full text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/20">
                <CogIcon className="h-5 w-5" />
              </Link>
            </div>
            <Button variant="primary" size="sm" className="shadow-indigo-200 shadow-md whitespace-nowrap">
              ログアウト
            </Button>
          </div>
        </div>
