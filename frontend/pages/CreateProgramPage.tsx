...
const mockPresentationsDB: Presentation[] = [
    ...
    { id: 6, student_number: 5406, student_name: '児玉 百合香', laboratory_id: 2, theme: '環境に左右されない物体検出', years_id: 2 },
    ...
    { id: 11, student_number: 5411, student_name: '長谷川 穂塚', laboratory_id: 3, theme: 'VR 環境におけるアバターの違いによるコミュニケーションについて', years_id: 2 },
...
const DynamicProgramPage: React.FC = () => {
    ...
    const [sessions, setSessions] = useState<Session[]>([
        ...
        { type: 'session', startTime: '14:40', endTime: '16:25', chair: '橋本 洪主', timekeeper: '大佐 悠惺' },
    ]);
    ...
    const handlePdfDownload = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.detail || 'PDF生成に失敗しました');
            }
            ...
            setErrorMessage(`PDF生成エラー: ${error instanceof Error ? error.message : '不明なエラー'}`);
        } finally {
